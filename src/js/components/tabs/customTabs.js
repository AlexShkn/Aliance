...
tabs(
	'.tabs', // обертка
	'.tabs__caption-list', // обертка кнопок
	'.tabs__content', // обертка для табов
	'.tabs__caption', // кнопка
	'tabs__caption_active', // класс активности для кнопки
	'tabs__body_active', // класс активности для таба
)
